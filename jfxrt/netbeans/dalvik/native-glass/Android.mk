...
LOCAL_SRC_FILES += input/dalvik/dalvikInput.c input/dalvik/dalvikUtils.c input/dalvik/screen.c
LOCAL_C_INCLUDES := $(LOCAL_PATH) $(LOCAL_PATH)/input/dalvik $(LOCAL_PATH)/../../../../build/generated-src/headers/glass/dalvik
LOCAL_CFLAGS := -DANDROID_NDK -DDALVIK_VM -DDEBUG -std=c99
