...
#include <math.h>
#include "SSEUtils.h"
#include "com_sun_scenario_effect_impl_sw_sse_SSEBlend_REDPeer.h"

JNIEXPORT void JNICALL
Java_com_sun_scenario_effect_impl_sw_sse_SSEBlend_1REDPeer_filter
...
jint src1w, jint src1h, jint src1scan)
{
    ...
    for (int dy = dsty; dy < dsty+dsth; dy++) {
        ...
        for (int dx = dstx; dx < dstx+dstw; dx++) {
            ...
            float blend_red_res_x, blend_red_res_y, blend_red_res_z, blend_red_res_w;
            {
            ...
            res_y = bot_tmp_y;
            res_z = bot_tmp_z;
            res_x = (1.0f - top_tmp_w) * bot_tmp_x + top_tmp_x;
            blend_red_res_x = res_x;
            blend_red_res_y = res_y;
            blend_red_res_z = res_z;
            blend_red_res_w = res_w;
            }

            }
            color_x = blend_red_res_x;
            color_y = blend_red_res_y;
            color_z = blend_red_res_z;
            color_w = blend_red_res_w;
            }
