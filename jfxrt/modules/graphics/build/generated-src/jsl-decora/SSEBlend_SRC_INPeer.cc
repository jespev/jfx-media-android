...
#include <math.h>
#include "SSEUtils.h"
#include "com_sun_scenario_effect_impl_sw_sse_SSEBlend_SRC_INPeer.h"

JNIEXPORT void JNICALL
Java_com_sun_scenario_effect_impl_sw_sse_SSEBlend_1SRC_1INPeer_filter
...
jint src1w, jint src1h, jint src1scan)
{
    ...
    for (int dy = dsty; dy < dsty+dsth; dy++) {
        ...
        for (int dx = dstx; dx < dstx+dstw; dx++) {
            ...
            float blend_src_in_res_x, blend_src_in_res_y, blend_src_in_res_z, blend_src_in_res_w;
            {
            ...
            {
            blend_src_in_res_x = top_tmp_x * bot_tmp_w;
            blend_src_in_res_y = top_tmp_y * bot_tmp_w;
            blend_src_in_res_z = top_tmp_z * bot_tmp_w;
            blend_src_in_res_w = top_tmp_w * bot_tmp_w;
            }

            }
            color_x = blend_src_in_res_x;
            color_y = blend_src_in_res_y;
            color_z = blend_src_in_res_z;
            color_w = blend_src_in_res_w;
            }
