...
public class JSWBlend_SRC_OUTPeer extends JSWEffectPeer  {
    ...
    public JSWBlend_SRC_OUTPeer(FilterContext fctx, Renderer r, String uniqueName) {
                            ...
                            ImageData... inputs)
    {
        ...
        for (int dy = dsty; dy < dsty+dsth; dy++) {
            ...
            for (int dx = dstx; dx < dstx+dstw; dx++) {
                ...
                float blend_src_out_res_x, blend_src_out_res_y, blend_src_out_res_z, blend_src_out_res_w;
                {
                ...
                {
                blend_src_out_res_x = top_tmp_x * (1.0f - bot_tmp_w);
                blend_src_out_res_y = top_tmp_y * (1.0f - bot_tmp_w);
                blend_src_out_res_z = top_tmp_z * (1.0f - bot_tmp_w);
                blend_src_out_res_w = top_tmp_w * (1.0f - bot_tmp_w);
                }

                }
                color_x = blend_src_out_res_x;
                color_y = blend_src_out_res_y;
                color_z = blend_src_out_res_z;
                color_w = blend_src_out_res_w;
                }
