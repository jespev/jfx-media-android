...
float surfaceScale : register(c12);
float3 lightPosition : register(c13);
float3 normalizedLightDirection : register(c14);
float lightSpecularExponent : register(c15);
...
float bumpA = tex2D(bumpImg, pos0).a;
