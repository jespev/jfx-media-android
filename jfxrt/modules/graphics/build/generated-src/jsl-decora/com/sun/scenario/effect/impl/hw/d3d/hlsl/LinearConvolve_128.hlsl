...
{
tmp += weights[24].x * tex2D(img, loc);
loc += offset.xy;
tmp += weights[24].y * tex2D(img, loc);
loc += offset.xy;
tmp += weights[24].z * tex2D(img, loc);
loc += offset.xy;
tmp += weights[24].w * tex2D(img, loc);
loc += offset.xy;
}
{
tmp += weights[25].x * tex2D(img, loc);
loc += offset.xy;
tmp += weights[25].y * tex2D(img, loc);
loc += offset.xy;
tmp += weights[25].z * tex2D(img, loc);
loc += offset.xy;
tmp += weights[25].w * tex2D(img, loc);
loc += offset.xy;
}
{
tmp += weights[26].x * tex2D(img, loc);
loc += offset.xy;
tmp += weights[26].y * tex2D(img, loc);
loc += offset.xy;
tmp += weights[26].z * tex2D(img, loc);
loc += offset.xy;
tmp += weights[26].w * tex2D(img, loc);
loc += offset.xy;
}
{
tmp += weights[27].x * tex2D(img, loc);
loc += offset.xy;
tmp += weights[27].y * tex2D(img, loc);
loc += offset.xy;
tmp += weights[27].z * tex2D(img, loc);
loc += offset.xy;
tmp += weights[27].w * tex2D(img, loc);
loc += offset.xy;
}
{
tmp += weights[28].x * tex2D(img, loc);
loc += offset.xy;
tmp += weights[28].y * tex2D(img, loc);
loc += offset.xy;
tmp += weights[28].z * tex2D(img, loc);
loc += offset.xy;
tmp += weights[28].w * tex2D(img, loc);
loc += offset.xy;
}
{
tmp += weights[29].x * tex2D(img, loc);
loc += offset.xy;
tmp += weights[29].y * tex2D(img, loc);
loc += offset.xy;
tmp += weights[29].z * tex2D(img, loc);
loc += offset.xy;
tmp += weights[29].w * tex2D(img, loc);
loc += offset.xy;
}
{
tmp += weights[30].x * tex2D(img, loc);
loc += offset.xy;
tmp += weights[30].y * tex2D(img, loc);
loc += offset.xy;
tmp += weights[30].z * tex2D(img, loc);
loc += offset.xy;
tmp += weights[30].w * tex2D(img, loc);
loc += offset.xy;
}
{
tmp += weights[31].x * tex2D(img, loc);
loc += offset.xy;
tmp += weights[31].y * tex2D(img, loc);
loc += offset.xy;
tmp += weights[31].z * tex2D(img, loc);
loc += offset.xy;
tmp += weights[31].w * tex2D(img, loc);
loc += offset.xy;
}
color = tmp;
}
