...
public class JSWBlend_MULTIPLYPeer extends JSWEffectPeer  {
    ...
    public JSWBlend_MULTIPLYPeer(FilterContext fctx, Renderer r, String uniqueName) {
                            ...
                            ImageData... inputs)
    {
        ...
        for (int dy = dsty; dy < dsty+dsth; dy++) {
            ...
            for (int dx = dstx; dx < dstx+dstw; dx++) {
                ...
                float blend_multiply_res_x, blend_multiply_res_y, blend_multiply_res_z, blend_multiply_res_w;
                {
                ...
                {
                blend_multiply_res_x = bot_tmp_x * (top_tmp_x + 1.0f - top_tmp_w) + top_tmp_x * (1.0f - bot_tmp_w);
                blend_multiply_res_y = bot_tmp_y * (top_tmp_y + 1.0f - top_tmp_w) + top_tmp_y * (1.0f - bot_tmp_w);
                blend_multiply_res_z = bot_tmp_z * (top_tmp_z + 1.0f - top_tmp_w) + top_tmp_z * (1.0f - bot_tmp_w);
                blend_multiply_res_w = bot_tmp_w * (top_tmp_w + 1.0f - top_tmp_w) + top_tmp_w * (1.0f - bot_tmp_w);
                }

                }
                color_x = blend_multiply_res_x;
                color_y = blend_multiply_res_y;
                color_z = blend_multiply_res_z;
                color_w = blend_multiply_res_w;
                }
