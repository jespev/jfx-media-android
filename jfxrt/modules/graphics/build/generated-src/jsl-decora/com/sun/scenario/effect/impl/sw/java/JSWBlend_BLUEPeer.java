...
public class JSWBlend_BLUEPeer extends JSWEffectPeer  {
    ...
    public JSWBlend_BLUEPeer(FilterContext fctx, Renderer r, String uniqueName) {
                            ...
                            ImageData... inputs)
    {
        ...
        for (int dy = dsty; dy < dsty+dsth; dy++) {
            ...
            for (int dx = dstx; dx < dstx+dstw; dx++) {
                ...
                float blend_blue_res_x, blend_blue_res_y, blend_blue_res_z, blend_blue_res_w;
                {
                ...
                res_x = bot_tmp_x;
                res_y = bot_tmp_y;
                res_z = (1.0f - top_tmp_w) * bot_tmp_z + top_tmp_z;
                blend_blue_res_x = res_x;
                blend_blue_res_y = res_y;
                blend_blue_res_z = res_z;
                blend_blue_res_w = res_w;
                }

                }
                color_x = blend_blue_res_x;
                color_y = blend_blue_res_y;
                color_z = blend_blue_res_z;
                color_w = blend_blue_res_w;
                }
