...
public class JSWBlend_DARKENPeer extends JSWEffectPeer  {
    ...
    public JSWBlend_DARKENPeer(FilterContext fctx, Renderer r, String uniqueName) {
                            ...
                            ImageData... inputs)
    {
        ...
        for (int dy = dsty; dy < dsty+dsth; dy++) {
            ...
            for (int dx = dstx; dx < dstx+dstw; dx++) {
                ...
                float blend_darken_res_x, blend_darken_res_y, blend_darken_res_z, blend_darken_res_w;
                {
                ...
                float max_res_x, max_res_y, max_res_z;
                {
                ...
                max_res_x = (x_tmp_x > y_tmp_x) ? x_tmp_x : y_tmp_x;
                max_res_y = (x_tmp_y > y_tmp_y) ? x_tmp_y : y_tmp_y;
                max_res_z = (x_tmp_z > y_tmp_z) ? x_tmp_z : y_tmp_z;

                }
                res_x = bot_tmp_x + top_tmp_x - max_res_x;
                res_y = bot_tmp_y + top_tmp_y - max_res_y;
                res_z = bot_tmp_z + top_tmp_z - max_res_z;
                blend_darken_res_x = res_x;
                blend_darken_res_y = res_y;
                blend_darken_res_z = res_z;
                blend_darken_res_w = res_w;
                }

                }
                color_x = blend_darken_res_x;
                color_y = blend_darken_res_y;
                color_z = blend_darken_res_z;
                color_w = blend_darken_res_w;
                }
