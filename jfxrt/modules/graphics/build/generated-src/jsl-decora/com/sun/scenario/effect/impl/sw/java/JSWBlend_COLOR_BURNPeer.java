...
public class JSWBlend_COLOR_BURNPeer extends JSWEffectPeer  {
    ...
    public JSWBlend_COLOR_BURNPeer(FilterContext fctx, Renderer r, String uniqueName) {
                            ...
                            ImageData... inputs)
    {
        ...
        for (int dy = dsty; dy < dsty+dsth; dy++) {
            ...
            for (int dx = dstx; dx < dstx+dstw; dx++) {
                ...
                float blend_color_burn_res_x, blend_color_burn_res_y, blend_color_burn_res_z, blend_color_burn_res_w;
                {
                ...
                res_x = (1.0f - top_tmp_w) * bot_tmp_x + (1.0f - bot_tmp_w) * top_tmp_x;
                res_y = (1.0f - top_tmp_w) * bot_tmp_y + (1.0f - bot_tmp_w) * top_tmp_y;
                res_z = (1.0f - top_tmp_w) * bot_tmp_z + (1.0f - bot_tmp_w) * top_tmp_z;
                float proda = bot_tmp_w * top_tmp_w;
                float topa2 = top_tmp_w * top_tmp_w;
                float tmp_x;
                float tmp_y;
                float tmp_z;
                if (bot_tmp_w == bot_tmp_x){
                tmp_x = proda;
                }
                 else if (top_tmp_x == 0.0f){
                tmp_x = 0.0f;
                }
                 else {
                tmp_x = topa2 * (bot_tmp_w - bot_tmp_x) / top_tmp_x;
                if (tmp_x >= proda){
                tmp_x = 0.0f;
                }
                 else {
                ...
                if (bot_tmp_w == bot_tmp_y){
                tmp_y = proda;
                }
                 else if (top_tmp_y == 0.0f){
                tmp_y = 0.0f;
                }
                 else {
                tmp_y = topa2 * (bot_tmp_w - bot_tmp_y) / top_tmp_y;
                if (tmp_y >= proda){
                tmp_y = 0.0f;
                }
                 else {
                ...
                if (bot_tmp_w == bot_tmp_z){
                tmp_z = proda;
                }
                 else if (top_tmp_z == 0.0f){
                tmp_z = 0.0f;
                }
                 else {
                tmp_z = topa2 * (bot_tmp_w - bot_tmp_z) / top_tmp_z;
                if (tmp_z >= proda){
                tmp_z = 0.0f;
                }
                 else {
                ...
                res_y = res_y + tmp_y;
                res_z = res_z + tmp_z;
                blend_color_burn_res_x = res_x;
                blend_color_burn_res_y = res_y;
                blend_color_burn_res_z = res_z;
                blend_color_burn_res_w = res_w;
                }

                }
                color_x = blend_color_burn_res_x;
                color_y = blend_color_burn_res_y;
                color_z = blend_color_burn_res_z;
                color_w = blend_color_burn_res_w;
                }
