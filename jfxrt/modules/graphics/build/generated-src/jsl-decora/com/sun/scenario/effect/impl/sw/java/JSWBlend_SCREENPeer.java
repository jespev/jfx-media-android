...
public class JSWBlend_SCREENPeer extends JSWEffectPeer  {
    ...
    public JSWBlend_SCREENPeer(FilterContext fctx, Renderer r, String uniqueName) {
                            ...
                            ImageData... inputs)
    {
        ...
        for (int dy = dsty; dy < dsty+dsth; dy++) {
            ...
            for (int dx = dstx; dx < dstx+dstw; dx++) {
                ...
                float blend_screen_res_x, blend_screen_res_y, blend_screen_res_z, blend_screen_res_w;
                {
                ...
                {
                blend_screen_res_x = bot_tmp_x + top_tmp_x - bot_tmp_x * top_tmp_x;
                blend_screen_res_y = bot_tmp_y + top_tmp_y - bot_tmp_y * top_tmp_y;
                blend_screen_res_z = bot_tmp_z + top_tmp_z - bot_tmp_z * top_tmp_z;
                blend_screen_res_w = bot_tmp_w + top_tmp_w - bot_tmp_w * top_tmp_w;
                }

                }
                color_x = blend_screen_res_x;
                color_y = blend_screen_res_y;
                color_z = blend_screen_res_z;
                color_w = blend_screen_res_w;
                }
