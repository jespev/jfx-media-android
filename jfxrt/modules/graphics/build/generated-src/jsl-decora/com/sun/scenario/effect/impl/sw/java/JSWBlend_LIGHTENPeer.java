...
public class JSWBlend_LIGHTENPeer extends JSWEffectPeer  {
    ...
    public JSWBlend_LIGHTENPeer(FilterContext fctx, Renderer r, String uniqueName) {
                            ...
                            ImageData... inputs)
    {
        ...
        for (int dy = dsty; dy < dsty+dsth; dy++) {
            ...
            for (int dx = dstx; dx < dstx+dstw; dx++) {
                ...
                float blend_lighten_res_x, blend_lighten_res_y, blend_lighten_res_z, blend_lighten_res_w;
                {
                ...
                res_x = bot_tmp_x + top_tmp_x - min_res_x;
                res_y = bot_tmp_y + top_tmp_y - min_res_y;
                res_z = bot_tmp_z + top_tmp_z - min_res_z;
                blend_lighten_res_x = res_x;
                blend_lighten_res_y = res_y;
                blend_lighten_res_z = res_z;
                blend_lighten_res_w = res_w;
                }

                }
                color_x = blend_lighten_res_x;
                color_y = blend_lighten_res_y;
                color_z = blend_lighten_res_z;
                color_w = blend_lighten_res_w;
                }
