...
float4 fractions[12] : register(c1);
sampler2D colors : register(s0);
float offset : register(c13);
...
float4 m0 : register(c14);
float4 m1 : register(c15);
float3 precalc : register(c16);
float3 perspVec : register(c17);
