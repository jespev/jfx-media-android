...
/*
 * $Id: Constants.java,v 1.7 2010-11-02 21:02:25 joehw Exp $
 */
 ...
 *
 * @version $Id: Constants.java,v 1.7 2010-11-02 21:02:25 joehw Exp $
 */
public final class Constants {
    ...
    private static final String [] zephyrFeatures ={
        XERCES_FEATURE_PREFIX + NAMESPACES_FEATURE,
        XERCES_FEATURE_PREFIX + WARN_ON_DUPLICATE_ATTDEF_FEATURE,
        XERCES_FEATURE_PREFIX + WARN_ON_UNDECLARED_ELEMDEF_FEATURE,
        XERCES_FEATURE_PREFIX + ALLOW_JAVA_ENCODINGS_FEATURE,
        
    } ;
    
    private static final String [] zephyrProperties = {
        XERCES_PROPERTY_PREFIX + SYMBOL_TABLE_PROPERTY,
        XERCES_PROPERTY_PREFIX + ERROR_REPORTER_PROPERTY,
        XERCES_PROPERTY_PREFIX + ERROR_HANDLER_PROPERTY,
        XERCES_PROPERTY_PREFIX + ENTITY_RESOLVER_PROPERTY,
        XERCES_PROPERTY_PREFIX + DTD_SCANNER_PROPERTY
    };
