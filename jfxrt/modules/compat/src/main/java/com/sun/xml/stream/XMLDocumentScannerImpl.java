...
/*
 * $Id: XMLDocumentScannerImpl.java,v 1.14 2010-11-02 21:02:26 joehw Exp $
 */
 ...
 * @version $Id: XMLDocumentScannerImpl.java,v 1.14 2010-11-02 21:02:26 joehw Exp $
 */
...
extends XMLDocumentFragmentScannerImpl {
    ...
    /**
    <!DOCTYPE root PUBLIC "..." SYSTEM "..." [
    <!ENTITY e "i am an entity"
    ]>
    */
            ...
            try {
                ...
                switch(fScannerState){
                    ...
                    case SCANNER_STATE_PI: {
                        //this function fills the data.. and also set the event to the current event..
