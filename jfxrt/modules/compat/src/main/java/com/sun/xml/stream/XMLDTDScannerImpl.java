...
/*
 * $Id: XMLDTDScannerImpl.java,v 1.6 2010-11-02 21:02:26 joehw Exp $
 */
 ...
 *
 * @version $Id: XMLDTDScannerImpl.java,v 1.6 2010-11-02 21:02:26 joehw Exp $
 */
...
implements XMLDTDScanner, XMLComponent, XMLEntityHandler {
    ...
    //new com.sun.xml.stream.dtd.XMLDTDProcessor();
    ...
    private void init() {
        ...
        // set starting state
        fSymbolTable = (SymbolTable)fPropertyManager.getProperty(Constants.XERCES_PROPERTY_PREFIX + Constants.SYMBOL_TABLE_PROPERTY);
        setScannerState(SCANNER_STATE_TEXT_DECL);
