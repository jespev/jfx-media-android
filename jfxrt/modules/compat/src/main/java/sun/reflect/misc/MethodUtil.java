...
class Trampoline {
    ...
    protected static void ensureInvocableMethod(Method m)
    ...
    protected static Object invoke(Method m, Object obj, Object[] params)
...
public final class MethodUtil extends SecureClassLoader {
    ...
    public static Object invoke(Method m, Object obj, Object[] params)
        throws InvocationTargetException, IllegalAccessException {
    	// circumvent security mechanics as webstart is not supported on android and 
    	// the classloader magic below results in a class not found exception
    	// Trampoline.ensureInvocableMethod(m);
    	return Trampoline.invoke(m, obj, params);
...
//        }
    ...
    private static Method getTrampoline() {
        try {
            ...
            throw (InternalError) new InternalError("bouncer cannot be found").initCause(e);
        }
    }
